...
class FormSosialEkonomi extends StatelessWidget {
  @override
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 20),
                      _buildTextField('Apa partai politik yang paling dominan di daerah anda?', isDarkMode),
                      SizedBox(height: 10),
                      ...
                      Center(
                        child: ElevatedButton(
                          onPressed: () {
                            // Logika ketika tombol Tambah Data ditekan
                          },
...
Widget _buildTextField(String labelText, bool isDarkMode, {int maxLines = 1}) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text(
      ...
      SizedBox(height: 8),
      Container(
        height: maxLines == 1 ? 45 : null, // Sesuaikan tinggi jika maxLines lebih dari 1
        child: TextField(
          maxLines: maxLines,
          style: TextStyle(
            fontSize: 14,
